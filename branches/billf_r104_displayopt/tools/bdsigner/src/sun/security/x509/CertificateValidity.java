/*
 * @(#)CertificateValidity.java	1.21 05/11/17
 *
...
// MHP 12.5.5.  Always use GeneralizedTime format for encode(OutputStream) method.
...
public class CertificateValidity implements CertAttrSet {
    ...
    public void encode(OutputStream out) throws IOException {
        ...
        // Start Blu-ray specific:
        // MHP 12.5.5.  Force GeneralizedTime format. 
