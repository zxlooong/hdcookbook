...
public class JarSigner {
	...
	// BD-J mandates using SHA1WithRSA as a signature Algorithm
        ...
        // Assuming that the usercert was generated by our version of sun.security.tools.CertAndKeyGen,
        // the certificate should have SubjectAlternativeNames and IssuerAlternativeNames as an extension,
        // with email address as a body.
        List altName = (List) userCert.getSubjectAlternativeNames().iterator().next();
        cg.addExtension(X509Extensions.SubjectAlternativeName.getId(), false,
            	getRfc822Name((String)altName.get(1)));

        List issuerName = (List) userCert.getIssuerAlternativeNames().iterator().next();
...
class SignatureFile {
     ...
     * BLU-RAY SPECIFIC:
     *
     * Refer to section 12.1.4.2.
     */
    private static final String BDJ_SIGNATURE_VERSION = 
         "BDJ-Signature-Version";
	...
	mattr.putValue(Attributes.Name.SIGNATURE_VERSION.toString(), "1.0");
         ...
         * BLU-RAY SPECIFIC:
         *
         * BDJ-Signature-Version has to be set to "1.0". See comment
         * above for spec.
         */ 
	mattr.putValue(BDJ_SIGNATURE_VERSION, "1.0");
	...
	Block(SignatureFile sfg, PrivateKey privateKey, 
	    ...
	    /*
	     * RSA with SHA1 is mandated by the BD-J spec.
	     * Always use SHA1 and not MD5 as used by the JDK jarsigner
	     */ 
